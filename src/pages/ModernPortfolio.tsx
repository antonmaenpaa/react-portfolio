...
function ModernPortfolio(): React.JSX.Element {
  ...
  return (
    <div className="font-poppins text-gray-800 bg-gray-50">
      ...
      <section id="hero" className="min-h-screen relative flex flex-col md:flex-row items-center justify-center overflow-hidden bg-white pt-20 md:pt-0 pb-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full h-full flex flex-col justify-center">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-20 mb-20 md:mb-0">
            
            {/* Text Content */}
            <div className="flex-1 text-center md:text-left order-2 md:order-1 w-full">
               <RevealOnScroll>
                <h1 className="text-5xl md:text-8xl font-bold text-gray-900 tracking-tight leading-tight mb-6">
                  Building <br/>
                  <span className="text-teal-primary">Digital</span> <span className="text-gray-400 italic font-serif">Experiences</span>
                </h1>
                <p className="text-lg md:text-2xl text-gray-500 font-light max-w-lg mx-auto md:mx-0 mb-8 md:mb-10">
            ...
            <div className="flex-1 relative order-1 md:order-2 flex justify-center md:justify-end w-full">
              <RevealOnScroll>
                <div className="relative w-64 h-64 md:w-[32rem] md:h-[32rem]">
